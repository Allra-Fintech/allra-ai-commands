...
> 사용 예: `/backend:qa-deploy-allra 20260430 https://github.com/Allra-Fintech/allra-v1-admin/pull/181 https://github.com/Allra-Fintech/allra-front-api/pull/910`
>
...
```
/backend:qa-deploy-allra 20260417 <URL1> <URL2> ...
```
